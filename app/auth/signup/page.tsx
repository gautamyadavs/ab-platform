    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 w-full max-w-md p-8">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-900">Create Researcher Account</h1>
          <p className="text-slate-500 mt-1 text-sm">Set up your account to run studies</p>
        </div>
